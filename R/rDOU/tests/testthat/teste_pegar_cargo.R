...
test_that("pega cargo da autoridade que assinou o ato", {
  expect_equal(pegar_cargo(ato1), "MINISTRO DE ESTADO DA AGRICULTURA, PECUÁ- RIA E ABASTECIMENTO")
  expect_equal(pegar_cargo(ato2), "SECRETÁRIO-EXECUTIVO DO MINISTÉRIO DA AGRICULTURA, PECUÁRIA E ABASTECIMENTO")
})
